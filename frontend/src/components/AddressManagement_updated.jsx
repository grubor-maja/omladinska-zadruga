                  ...
                  <table className="table table-striped">
                    ...
                    <tbody>
                      {municipalities.map((municipality) => {
                        const municipalityAddresses = addresses.filter(addr => addr[3] === municipality[0]);
                    ...
                    <tbody>
                      {cities.map((city) => {
                        ...
                        const totalAddresses = cityMunicipalities.reduce((total, mun) => 
                          total + addresses.filter(addr => addr[3] === mun[0]).length, 0);
                ...
                <div className="modal-body">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setMunicipalityForm({...municipalityForm, nazivOpstine: e.target.value})}
                      required
                    />
                  </div>
                  <div className="mb-3">
